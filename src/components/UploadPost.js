...
const UploadPost = ({ _id, profile_pic }) => {
  ...
  return (
    <div className="bg-white p-4 rounded">
      <div className="flex gap-4 items-start">
        <Avatar imageURL={profile_pic} width={50} height={50} userId={_id} />
        ...
        <div className="w-full">
          ...
          {data?.image && (
            <div className="bg-slate-100 border text-center relative py-2 px-4">
              <div
                className="w-5 h-5 text-sm hover:text-red-600 cursor-pointer rounded-full absolute right-0 top-0"
      ...
      <div className="flex justify-between items-center">
        ...
        <button
          className="bg-blue-700 px-5 py-1 text-white rounded-full"
          onClick={handlePost}
          >
          Post
        </button>
